...
public interface IDangKyLichTrinhChiTietTMXPresenter {
    void dangKyLichTrinhChiTiet(String registerId, List<DanhSachKhachHangDangKyResponse> danhSachKhachHangDangKyResponse);
}
