...
public class TypeCompanyOfflineAdapter extends BaseAdapter {

	private LayoutInflater mLayoutInflater;
	private ArrayList<TypeCompany> mArrayListData;

	public TypeCompanyOfflineAdapter(Context context, ArrayList<TypeCompany> data) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// Fill data
		TypeCompany item = mArrayListData.get(position);
		if (item != null) {
