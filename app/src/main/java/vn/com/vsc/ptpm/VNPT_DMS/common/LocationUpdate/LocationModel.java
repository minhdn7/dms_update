...
public class LocationModel {
	...
	public LocationModel(int id, String code, String assign, double lat,
			double lng, String time, int pin, String type_network, int value,
	...
	public String toString() {
		return "InfoDeviceEntity [id=" + id + ", code=" + code + ", assign="
				+ assign + ", lat=" + lat + ", lng=" + lng + ", time=" + time
				+ ", pin=" + pin + ", type_network=" + type_network
				+ ", value=" + value + ", send_status=" + send_status
				+ ", distance=" + distance
				+ ", accuracy=" + accuracy
	...
	public String toStringData() {
		return id + "," + code + "," + assign + "," + lat + "," + lng + ","
				+ time + "," + pin + "," + type_network + "," + value + ","
				+ send_status + "," + distance
