...
public class HinhThucThanhToanOfflineAdapter extends BaseAdapter {

	private LayoutInflater mLayoutInflater;
	private ArrayList<HTTT> mArrayListData;

	public HinhThucThanhToanOfflineAdapter(Context context, ArrayList<HTTT> data) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// Fill data
		HTTT item = mArrayListData.get(position);
		if (item != null) {
			viewHoler.mId.setText("" + item.getHttt_id());
			viewHoler.mName.setText(ConvertFont.getUTF8StringFromNCR(item.getHinhthuc()));
		}
